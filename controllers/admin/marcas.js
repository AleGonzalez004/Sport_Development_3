        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td></td>
                    <td>
                <button type="button" class="btn btn-dark me-2 mb-2 mb-sm-2" onclick="openUpdate(${row.ID_MARCA})">
                            <i class="bi bi-pencil-fill"></i>
                        </button>
                <button type="button" class="btn btn-dark me-2 mb-2 mb-sm-2" onclick="openDelete(${row.ID_MARCA})">
